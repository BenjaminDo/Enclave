...
public class BlackGem : MonoBehaviour 
{
	/*		MEMBERS			*/
	...
	void Awake()
	{
		...
		InitialColor = Color.black;																		//Définition de la couleur initiale de la Gemme
		OppositeColor = Color.white;																	//Définition de la couleur opposé de la Gemme
	...
	void Start () 
	{
		...
		GemPartEmitter.worldVelocity = new Vector3(2.5f,-1.0f,0.0f);									//Vitesse d'émission des particules (x,y,z) ; "Distance de projection"
		...
		GemPartStarkle[0] = new Color32(255,255,255,30);												
		GemPartStarkle[1] = new Color32(255,255,255,180);
		GemPartStarkle[2] = new Color32(255,255,255,255);
		GemPartStarkle[3] = new Color32(218,255,255,180);
		GemPartStarkle[4] = new Color32(255,255,255,10);
	...
	void OnMouseOver()
	{
		GemTitle.text = "Achivements";																	//Initilaisation du titre de la Gemme
